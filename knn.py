...
def knn_cross_validate(x_train, y_train, num_folds=5, k_choices=None):
  ...
  #     a = KnnClassifier(x_train_folds[j], y_train_folds[j])  
  #     l.append(a.check_accuracy(x_train_folds[j+1], y_train_folds[j+1], k = k_choices[i]))
  #   k_to_accuracies[k_choices[i]] = l; 
  pass
  ##############################################################################
  #                            END OF YOUR CODE                                #
  ##############################################################################
